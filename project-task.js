...
// Script 3 - Product calculation
function multiplyNumbers(number1 = 0, number2 = 0)
{
   return number1 * number2;
}

console.log(`The product of ${number1} and ${number2} is ${multiplyNumbers(number1, number2)}`);
